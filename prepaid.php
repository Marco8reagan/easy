...
<body>
		<div class="wrapper">
              ...
              <div class="container-fluid d-grid gap-3 align-items-center">
              	<div class="row text-white"><div class="col-5"><a href="home.html" style="text-decoration: none; color: white;"><i class="bi bi-chevron-left float-left"></i></a></div><div class="col-6"><h2 style="text-align: left !important;">Pay Electricity</h2></div></div>
              	<hr></hr>
                     <div class="d-flex justify-content-between">
<ul class="nav nav-pills nav-fill">
  <li class="nav-item">
    <a class="nav-link active" aria-current="page"href="#" style="color: white;font-weight: bolder;">Prepaid</a>
  </li>
   <li class="nav-item">
    <a class="nav-link" aria-current="page" href="postpay.html" style="color: white; font-weight: lighter;">Postpaid</a>
  </li>
</ul>
                  </div>               
		...
		<div class="col-12">
			<form>
				<div class="mb-3 text-start">
				  <label for="exampleInputEmail/PhoneNumber1" class="form-label text-yellow form-lbl">Enter Account/Meter Number</label>
