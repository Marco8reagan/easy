...
<body>
		<div class="wrapper">
              ...
              <div class="container-fluid d-grid gap-3 align-items-center">
              	<div class="row text-white"><div class="col-5"><a href="home.html" style="text-decoration: none; color: white;"><i class="bi bi-chevron-left float-left"></i></a></div><div class="col-6"><h2 style="text-align: left !important;">Buy Bundles</h2></div></div>
              	<hr></hr>
...
<ul class="nav nav-pills nav-fill">
  ...
  <li class="nav-item">
    <a class="nav-link active" aria-current="page"href="#" style="color: white;font-weight: bolder;">self</a>
  </li>
   <li class="nav-item">
    <a class="nav-link" aria-current="page" href="otherbundles.html" style="color: white; font-weight: lighter;">other</a>
  </li>
</ul>
                  </div>               
